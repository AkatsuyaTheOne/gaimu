...
# Usage: godot --headless -s core/smoke_test_cli.gd
...
func test_module_loading():
	...
	# Test BaseModule
	var base_module_script = load("res://core/base_module.gd")
	...
	# Test PlayerModule
	var player_module_script = load("res://player/player_module.gd")
	...
	# Test EnemyModule
	var enemy_module_script = load("res://enemy/enemy_module.gd")
	...
	var game_manager_module_script = load("res://core/game_manager_module.gd")
	...
	var enemy_spawner_module_script = load("res://core/enemy_spawner_module.gd")
	...
	var ui_manager_module_script = load("res://ui/ui_manager_module.gd")
